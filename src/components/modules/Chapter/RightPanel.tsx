      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {viewMode === "Translation" && (
          <div className="border-b dark:border-neutral-800">
            ...
            {readingOpen && (
              <div className="px-4 pb-4 text-sm text-gray-500">Reading settings coming soon.</div>
            )}
          </div>
        )}
            ...
            {mushafOpen && (
              <div className="px-4 pb-4 space-y-3">
                {MUSHAF_OPTIONS.map((m) => (
                  <button key={m.id} onClick={() => setMushaf(m.id)} className="flex items-center gap-3 w-full cursor-pointer">
        ...
        <div className="m-4 rounded-2xl bg-green-50 dark:bg-green-900/20 border border-green-100 dark:border-green-800 p-4">
          <p className="text-sm font-semibold text-gray-800 dark:text-gray-200 mb-1">Help spread the knowledge of Islam</p>
